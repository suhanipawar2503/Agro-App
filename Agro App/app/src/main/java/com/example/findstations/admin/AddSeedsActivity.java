...
public class AddSeedsActivity extends AppCompatActivity {
    ...
    public void btnSubmitClick(View view) {
        ...
        pDialog = new ProgressDialog(AddSeedsActivity.this);
        pDialog.setMessage("validating your details, please wait...");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
        pDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DBClass.urlAddSeeds,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getString("status").equals("success")) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), AdminSeedsActivity.class);
