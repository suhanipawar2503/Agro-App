...
public class AdminHerbicidesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_herbicides);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              Intent intent = new Intent(AdminHerbicidesActivity.this, AddHerbicidesActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rview.setLayoutManager(new GridLayoutManager(AdminHerbicidesActivity.this, 2));
