...
public class AddHerbicidesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_herbicides);
    ...
    public void btnSubmitClick(View view) {
        ...
        pDialog = new ProgressDialog(AddHerbicidesActivity.this);
        pDialog.setMessage("validating your details, please wait...");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
        pDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DBClass.urlAddHerbicides,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getString("status").equals("success")) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), AdminHerbicidesActivity.class);
