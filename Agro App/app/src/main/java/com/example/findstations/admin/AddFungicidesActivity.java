...
public class AddFungicidesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_fungicides);
    ...
    public void btnSubmitClick(View view) {
        ...
        pDialog = new ProgressDialog(AddFungicidesActivity.this);
        pDialog.setMessage("validating your details, please wait...");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
        pDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DBClass.urlAddFungicides,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getString("status").equals("success")) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), AdminFungicidesActivity.class);
